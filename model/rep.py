...
df = pd.read_csv("/content/drive/MyDrive/Colab_Notebooks/Walsh_University/Project_2_MLOps/data/tourism.csv")   # complete the code: path to the registered tourism.csv inside the data folder
