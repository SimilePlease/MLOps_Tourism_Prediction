...
model_path = os.path.join(os.path.dirname(__file__), "/content/drive/MyDrive/Colab_Notebooks/Walsh_University/Project_2_MLOps/model/")   # complete the code: filename of the trained model saved by train.py (must match the filename you used there)
